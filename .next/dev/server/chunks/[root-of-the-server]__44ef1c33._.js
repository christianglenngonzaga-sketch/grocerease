...
async function GET(req) {
    try {
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$grocer$2d$ease$2d$sql$2d$schema$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute(sql, params);
...
async function POST(req) {
    try {
        ...
        const { name, quantity = 1, quantity_unit = "pcs", notes = null, category_id = null, purchased = false, priority = "medium", estimated_price = null } = body;
        ...
        const [res] = await __TURBOPACK__imported__module__$5b$project$5d2f$grocer$2d$ease$2d$sql$2d$schema$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute(`INSERT INTO items
...
//# sourceMappingURL=%5Broot-of-the-server%5D__44ef1c33._.js.map