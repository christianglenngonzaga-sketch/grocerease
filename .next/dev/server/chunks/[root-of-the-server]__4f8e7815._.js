...
"[project]/grocer-ease-sql-schema/app/api/auth/me/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const [rows] = await __TURBOPACK__imported__module__$5b$project$5d2f$grocer$2d$ease$2d$sql$2d$schema$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute("SELECT id, email, first_name, last_name, created_at FROM users WHERE id = ?", [
            payload.userId
        ]);
        const user = rows[0];
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4f8e7815._.js.map