...
"[project]/grocer-ease-sql-schema/app/api/auth/register/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        // prevent duplicate
        const [existing] = await __TURBOPACK__imported__module__$5b$project$5d2f$grocer$2d$ease$2d$sql$2d$schema$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute("SELECT id FROM users WHERE email = ?", [
            email
        ]);
        ...
        const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$grocer$2d$ease$2d$sql$2d$schema$2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].hash(password, 10);
        const [res] = await __TURBOPACK__imported__module__$5b$project$5d2f$grocer$2d$ease$2d$sql$2d$schema$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute("INSERT INTO users (email, password_hash, first_name, last_name) VALUES (?, ?, ?, ?)", [
            email,
            hash,
            first_name,
            last_name
        ...
        for (const c of defaultCategories){
            await __TURBOPACK__imported__module__$5b$project$5d2f$grocer$2d$ease$2d$sql$2d$schema$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].execute("INSERT INTO categories (user_id, name, color, icon) VALUES (?, ?, ?, ?)", [
                userId,
                c.name,
                c.color,
                c.icon
...
//# sourceMappingURL=%5Broot-of-the-server%5D__5a61bbe0._.js.map